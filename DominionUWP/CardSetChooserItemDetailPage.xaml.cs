...
namespace DominionUWP
{
	...
	/// </summary>
	public sealed partial class CardSetChooserItemDetailPage : Page
	{
		...
		public CardSetChooserItemDetailPage()
		{
		...
		private void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
		{
			...
			string cardSetName = (string)e.NavigationParameter;
			this.DataContext = App.Context.CardSetsModel.CardSetLookup[cardSetName];
		}
